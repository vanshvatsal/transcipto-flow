...
export default function Information(props) {
    ...
    function handleDownload() {
        ...
        element.download = `Transcripto_Flow_${new Date().toString()}.txt`
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 max-w-prose w-full mx-auto'>
            {tab === "transcription" ? <h1 className='font-semibold text-4xl sm:text-5xl md:text-6xl whitespace-nowrap'>Your <span className='text-blue-400 bold'>Transcription</span></h1>
                : <h1 className='font-semibold text-4xl sm:text-5xl md:text-6xl whitespace-nowrap'>Your <span className='text-blue-400 bold'>Translation</span></h1>
            }
